...
public class FormConcernPackageImpl extends EPackageImpl implements FormConcernPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getForm_ElementsNumber(), ecorePackage.getEIntegerObject(), "elementsNumber", null, 0, 1, Form.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
