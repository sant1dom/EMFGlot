 ...
 * </p>
 * <ul>
 *   <li>{@link Glot2.ContentConcern.impl.IndexImpl#getIndividuals <em>Individuals</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IndexImpl extends DynamicContentImpl implements Index {
	...
	public EList<Individual> getIndividuals() {
		if (individuals == null) {
			individuals = new EObjectResolvingEList<Individual>(Individual.class, this, ContentConcernPackage.INDEX__INDIVIDUALS);
		}
		return individuals;
	}
	...
	public boolean NoDuplicates(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			if (le) {
				...
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_Glot2_c_c_ContentConcern_c_c_Index_0 = idResolver.getClass(ContentConcernTables.CLSSid_Index, null);
				final /*@NonInvalid*/ SetValue allInstances = ClassifierAllInstancesOperation.INSTANCE.evaluate(executor, ContentConcernTables.SET_CLSSid_Index, TYP_Glot2_c_c_ContentConcern_c_c_Index_0);
