 ...
 * </p>
 * <ul>
 *   <li>{@link Glot2.ContentConcern.impl.DynamicContentImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link Glot2.ContentConcern.impl.DynamicContentImpl#getFeatures <em>Features</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DynamicContentImpl extends ContentImpl implements DynamicContent {
	...
	protected EClass eStaticClass() {
		return ContentConcernPackage.Literals.DYNAMIC_CONTENT;
	}
		...
		if (entity != null && entity.eIsProxy()) {
			...
			if (entity != oldEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ContentConcernPackage.DYNAMIC_CONTENT__ENTITY, oldEntity, entity));
			}
		}
		return entity;
	}
	...
	public void setEntity(Entity newEntity) {
		...
		entity = newEntity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ContentConcernPackage.DYNAMIC_CONTENT__ENTITY, oldEntity, entity));
	}
	...
	public EList<Feature> getFeatures() {
		if (features == null) {
			features = new EObjectResolvingEList<Feature>(Feature.class, this, ContentConcernPackage.DYNAMIC_CONTENT__FEATURES);
		}
		return features;
	}
	...
	public boolean OnlyFeaturesFromRef(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "DynamicContent::OnlyFeaturesFromRef";
		try {
			/**
			 *
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, ContentConcernPackage.Literals.DYNAMIC_CONTENT___ONLY_FEATURES_FROM_REF__DIAGNOSTICCHAIN_MAP);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ContentConcernPackage.DYNAMIC_CONTENT__ENTITY:
				if (resolve) return getEntity();
				return basicGetEntity();
			case ContentConcernPackage.DYNAMIC_CONTENT__FEATURES:
				return getFeatures();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ContentConcernPackage.DYNAMIC_CONTENT___ONLY_FEATURES_FROM_REF__DIAGNOSTICCHAIN_MAP:
