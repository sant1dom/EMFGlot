 ...
 * </p>
 * <ul>
 *   <li>{@link Glot2.impl.NamedElementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamedElementImpl extends MinimalEObjectImpl.Container implements NamedElement {
	...
	protected EClass eStaticClass() {
		return Glot2Package.Literals.NAMED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Glot2Package.NAMED_ELEMENT__NAME, oldName, name));
	}
	...
	public boolean NameIsDefined(final String name) {
		...
		final /*@NonInvalid*/ boolean eq = name.equals(Glot2Tables.STR_);
		or = eq;
		if (or == null) {
			throw new InvalidValueException("Null body for \'Glot2::NamedElement::NameIsDefined(String[1]) : Boolean[1]\'");
		}
		return or;
	}
	...
	public boolean NameNotEmpty(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, Glot2Package.Literals.NAMED_ELEMENT___NAME_NOT_EMPTY__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				try {
					...
					if (eq) {
						...
						final /*@Thrown*/ TupleValue local_0 = ValueUtil.createTupleOfEach(Glot2Tables.TUPLid_, Glot2Tables.STR_Expected_32_a_32_name, status);
						local_1 = local_0;
					}
				...
				final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, constraintName, this, (Object)null, diagnostics, context, (Object)null, severity_0, CAUGHT_local_1, Glot2Tables.INT_0).booleanValue();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Glot2Package.NAMED_ELEMENT__NAME:
				return getName();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Glot2Package.NAMED_ELEMENT___NAME_IS_DEFINED__STRING:
				return NameIsDefined((String)arguments.get(0));
			case Glot2Package.NAMED_ELEMENT___NAME_NOT_EMPTY__DIAGNOSTICCHAIN_MAP:
