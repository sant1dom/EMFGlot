...
import Glot2.ContentConcern.impl.ContentConcernPackageImpl;
 ...
 * @generated
 */
public class Glot2PackageImpl extends EPackageImpl implements Glot2Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see Glot2.Glot2Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Glot2PackageImpl() {
		super(eNS_URI, Glot2Factory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link Glot2Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Glot2Package init() {
		if (isInited) return (Glot2Package)EPackage.Registry.INSTANCE.getEPackage(Glot2Package.eNS_URI);

		// Obtain or create and register package
		Object registeredGlot2Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		Glot2PackageImpl theGlot2Package = registeredGlot2Package instanceof Glot2PackageImpl ? (Glot2PackageImpl)registeredGlot2Package : new Glot2PackageImpl();
			...
			(theGlot2Package,
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return Glot2Validator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theGlot2Package.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Glot2Package.eNS_URI, theGlot2Package);
		return theGlot2Package;
	}
	 ...
	 * @generated
	 */
	public Glot2Factory getGlot2Factory() {
		return (Glot2Factory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEClass(systemEClass, Glot2.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSystem_Version(), ecorePackage.getEInt(), "version", null, 1, 1, Glot2.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSystem_Subversion(), ecorePackage.getEInt(), "subversion", null, 1, 1, Glot2.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Entities(), theDataConcernPackage.getEntity(), null, "entities", null, 0, -1, Glot2.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Forms(), theFormConcernPackage.getForm(), null, "forms", null, 0, -1, Glot2.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Pages(), theContentConcernPackage.getPage(), null, "pages", null, 0, -1, Glot2.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSystem_FullVersion(), ecorePackage.getEString(), "fullVersion", null, 1, 1, Glot2.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
