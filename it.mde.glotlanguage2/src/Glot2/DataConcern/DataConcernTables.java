...
public class DataConcernTables extends AbstractTables
{
	...
	public static final /*@NonInvalid*/ ClassId CLSSid_Attribute = DataConcernTables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_dataConcern.getClassId("Attribute", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Class = DataConcernTables.PACKid_$metamodel$.getClassId("Class", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_DynamicContent = DataConcernTables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_contenConcern.getClassId("DynamicContent", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Element = DataConcernTables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_formConcern.getClassId("Element", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Entity = DataConcernTables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_dataConcern.getClassId("Entity", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Feature = DataConcernTables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_dataConcern.getClassId("Feature", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Form = DataConcernTables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_formConcern.getClassId("Form", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Reference = DataConcernTables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_dataConcern.getClassId("Reference", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_System = DataConcernTables.PACKid_https_c_s_s_it_mde_glotlanguage2.getClassId("System", 0);
	public static final /*@NonInvalid*/ EnumerationId ENUMid__DataType = DataConcernTables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_dataConcern.getEnumerationId("_DataType");
	public static final /*@NonInvalid*/ IntegerValue INT_0 = ValueUtil.integerValueOf("0");
	public static final /*@NonInvalid*/ IntegerValue INT_1 = ValueUtil.integerValueOf("1");
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_DynamicContent = TypeId.BAG.getSpecializedId(DataConcernTables.CLSSid_DynamicContent);
	...
	public static final /*@NonInvalid*/ CollectionTypeId SET_CLSSid_Entity = TypeId.SET.getSpecializedId(DataConcernTables.CLSSid_Entity);
	...
	public static class Fragments {
		...
		private static final ExecutorFragment _Attribute__NamedElement = new ExecutorFragment(Types._Attribute, Glot2Tables.Types._NamedElement);
		...
		private static final ExecutorFragment _Entity__NamedElement = new ExecutorFragment(Types._Entity, Glot2Tables.Types._NamedElement);
		...
		private static final ExecutorFragment _Feature__NamedElement = new ExecutorFragment(Types._Feature, Glot2Tables.Types._NamedElement);
		...
		private static final ExecutorFragment _Reference__NamedElement = new ExecutorFragment(Types._Reference, Glot2Tables.Types._NamedElement);
	...
	public static class Properties {
		...
		public static final ExecutorProperty _Entity__DynamicContent__entity = new ExecutorPropertyWithImplementation("DynamicContent", Types._Entity, 1, new EcoreLibraryOppositeProperty(ContentConcernPackage.Literals.DYNAMIC_CONTENT__ENTITY));
		...
		public static final ExecutorProperty _Entity__Reference__foreignKey = new ExecutorPropertyWithImplementation("Reference", Types._Entity, 3, new EcoreLibraryOppositeProperty(DataConcernPackage.Literals.REFERENCE__FOREIGN_KEY));
		public static final ExecutorProperty _Entity__System__entities = new ExecutorPropertyWithImplementation("System", Types._Entity, 4, new EcoreLibraryOppositeProperty(Glot2Package.Literals.SYSTEM__ENTITIES));

		public static final ExecutorProperty _Feature__DynamicContent__features = new ExecutorPropertyWithImplementation("DynamicContent", Types._Feature, 0, new EcoreLibraryOppositeProperty(ContentConcernPackage.Literals.DYNAMIC_CONTENT__FEATURES));
	...
	public static class EnumerationLiterals {
		...
		public static final EcoreExecutorEnumerationLiteral __DataType__double = new EcoreExecutorEnumerationLiteral(DataConcernPackage.Literals._DATA_TYPE.getEEnumLiteral("double"), Types.__DataType, 6);
