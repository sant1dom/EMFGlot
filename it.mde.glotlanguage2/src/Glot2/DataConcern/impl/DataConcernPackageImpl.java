...
import Glot2.DataConcern._DataType;

import Glot2.DataConcern.util.DataConcernValidator;
...
public class DataConcernPackageImpl extends EPackageImpl implements DataConcernPackage {
	 ...
	 * @see Glot2.DataConcern.DataConcernPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		entityEClass.getESuperTypes().add(theGlot2Package.getNamedElement());
		featureEClass.getESuperTypes().add(theGlot2Package.getNamedElement());
		...
		initEReference(getReference_ForeignKey(), this.getEntity(), null, "foreignKey", null, 1, 1, Reference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
