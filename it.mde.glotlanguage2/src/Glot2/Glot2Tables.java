 ...
 * from:
 *   /it.mde.glotlanguage2/WebApplication2/glotlanguage2.ecore
 * using:
...
/**
 * Glot2Tables provides the dispatch tables for the Glot2 for use by the OCL dispatcher.
 *
 * In order to ensure correct static initialization, a top level class element must be accessed
 * before any nested class element. Therefore an access to PACKAGE.getClass() is recommended.
 */
public class Glot2Tables extends AbstractTables
{
	static {
		Init.initStart();
	}
	 ...
	 */
	public static final EcoreExecutorPackage PACKAGE = new EcoreExecutorPackage(Glot2Package.eINSTANCE);
	...
	public static final /*@NonInvalid*/ ClassId CLSSid_Entity = Glot2Tables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_dataConcern.getClassId("Entity", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Form = Glot2Tables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_formConcern.getClassId("Form", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_NamedElement = Glot2Tables.PACKid_https_c_s_s_it_mde_glotlanguage2.getClassId("NamedElement", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Page = Glot2Tables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_contenConcern.getClassId("Page", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_System = Glot2Tables.PACKid_https_c_s_s_it_mde_glotlanguage2.getClassId("System", 0);
	public static final /*@NonInvalid*/ DataTypeId DATAid_EInt = Glot2Tables.PACKid_http_c_s_s_www_eclipse_org_s_emf_s_2002_s_Ecore.getDataTypeId("EInt", 0);
	...
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Entity = TypeId.ORDERED_SET.getSpecializedId(Glot2Tables.CLSSid_Entity);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Form = TypeId.ORDERED_SET.getSpecializedId(Glot2Tables.CLSSid_Form);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Page = TypeId.ORDERED_SET.getSpecializedId(Glot2Tables.CLSSid_Page);
	public static final /*@NonInvalid*/ TupleTypeId TUPLid_ = IdManager.getTupleTypeId("Tuple", Glot2Tables.PARTid_, Glot2Tables.PARTid__0);
	...
	public static class TypeParameters {
		...
		/**
		 * Force initialization of the fields of Glot2Tables::TypeParameters and all preceding sub-packages.
		 */
	...
	public static class Types {
		...
		public static final EcoreExecutorType _NamedElement = new EcoreExecutorType(Glot2Package.Literals.NAMED_ELEMENT, PACKAGE, 0);
		public static final EcoreExecutorType _System = new EcoreExecutorType(Glot2Package.Literals.SYSTEM, PACKAGE, 0);
		...
		/**
		 * Force initialization of the fields of Glot2Tables::Types and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class Fragments {
		...
		private static final ExecutorFragment _NamedElement__NamedElement = new ExecutorFragment(Types._NamedElement, Glot2Tables.Types._NamedElement);
		...
		private static final ExecutorFragment _System__NamedElement = new ExecutorFragment(Types._System, Glot2Tables.Types._NamedElement);
		...
		private static final ExecutorFragment _System__System = new ExecutorFragment(Types._System, Glot2Tables.Types._System);
		...
		/**
		 * Force initialization of the fields of Glot2Tables::Fragments and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class Parameters {
		...
		/**
		 * Force initialization of the fields of Glot2Tables::Parameters and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class Operations {
		...
		/**
		 * Force initialization of the fields of Glot2Tables::Operations and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class Properties {
		...
		public static final ExecutorProperty _NamedElement__name = new EcoreExecutorProperty(Glot2Package.Literals.NAMED_ELEMENT__NAME, Types._NamedElement, 0);

		public static final ExecutorProperty _System__entities = new EcoreExecutorProperty(Glot2Package.Literals.SYSTEM__ENTITIES, Types._System, 0);
		public static final ExecutorProperty _System__forms = new EcoreExecutorProperty(Glot2Package.Literals.SYSTEM__FORMS, Types._System, 1);
		public static final ExecutorProperty _System__fullVersion = new EcoreExecutorProperty(Glot2Package.Literals.SYSTEM__FULL_VERSION, Types._System, 2);
		public static final ExecutorProperty _System__pages = new EcoreExecutorProperty(Glot2Package.Literals.SYSTEM__PAGES, Types._System, 3);
		public static final ExecutorProperty _System__subversion = new EcoreExecutorProperty(Glot2Package.Literals.SYSTEM__SUBVERSION, Types._System, 4);
		public static final ExecutorProperty _System__version = new EcoreExecutorProperty(Glot2Package.Literals.SYSTEM__VERSION, Types._System, 5);
		static {
			Init.initEnd();
		}

		/**
		 * Force initialization of the fields of Glot2Tables::Properties and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class TypeFragments {
		...
		/**
		 * Force initialization of the fields of Glot2Tables::TypeFragments and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class FragmentOperations {
		...
		private static final ExecutorOperation /*@NonNull*/ [] _System__System = {
			Glot2Tables.Operations._System__JoinVersion /* JoinVersion(EInt[1],EInt[1]) */
		};
		...
		/**
		 * Force initialization of the fields of Glot2Tables::FragmentOperations and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class FragmentProperties {
		...
		private static final ExecutorProperty /*@NonNull*/ [] _System = {
			Glot2Tables.Properties._System__entities,
			Glot2Tables.Properties._System__forms,
			Glot2Tables.Properties._System__fullVersion,
			Glot2Tables.Properties._NamedElement__name,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
			Glot2Tables.Properties._System__pages,
			Glot2Tables.Properties._System__subversion,
			Glot2Tables.Properties._System__version
		};
		...
		/**
		 * Force initialization of the fields of Glot2Tables::FragmentProperties and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class EnumerationLiterals {
		...
		/**
		 * Force initialization of the fields of Glot2Tables::EnumerationLiterals and all preceding sub-packages.
		 */
		public static void init() {}
	}
