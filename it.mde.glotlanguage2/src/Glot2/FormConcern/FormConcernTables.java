...
// import Glot2.FormConcern.FormConcernTables;
...
public class FormConcernTables extends AbstractTables
{
	...
	public static final /*@NonInvalid*/ ClassId CLSSid_Attribute = FormConcernTables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_dataConcern.getClassId("Attribute", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Element = FormConcernTables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_formConcern.getClassId("Element", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Entity = FormConcernTables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_dataConcern.getClassId("Entity", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Form = FormConcernTables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_formConcern.getClassId("Form", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Page = FormConcernTables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_contenConcern.getClassId("Page", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_System = FormConcernTables.PACKid_https_c_s_s_it_mde_glotlanguage2.getClassId("System", 0);
	...
	public static final /*@NonInvalid*/ EnumerationId ENUMid__MethodType = FormConcernTables.PACKid_https_c_s_s_it_mde_glotlanguage2_s_formConcern.getEnumerationId("_MethodType");
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_Page = TypeId.BAG.getSpecializedId(FormConcernTables.CLSSid_Page);
	...
	public static class Fragments {
		...
		private static final ExecutorFragment _Element__NamedElement = new ExecutorFragment(Types._Element, Glot2Tables.Types._NamedElement);
		...
		private static final ExecutorFragment _Form__NamedElement = new ExecutorFragment(Types._Form, Glot2Tables.Types._NamedElement);
	...
	public static class Properties {
		...
		public static final ExecutorProperty _Form__Page__forms = new ExecutorPropertyWithImplementation("Page", Types._Form, 4, new EcoreLibraryOppositeProperty(ContentConcernPackage.Literals.PAGE__FORMS));
		public static final ExecutorProperty _Form__System__forms = new ExecutorPropertyWithImplementation("System", Types._Form, 5, new EcoreLibraryOppositeProperty(Glot2Package.Literals.SYSTEM__FORMS));
		static {
			Init.initEnd();
		}
