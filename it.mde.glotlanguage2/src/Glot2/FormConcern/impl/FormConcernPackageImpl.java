...
public class FormConcernPackageImpl extends EPackageImpl implements FormConcernPackage {
	 ...
	 * @see Glot2.FormConcern.FormConcernPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		elementEClass.getESuperTypes().add(theGlot2Package.getNamedElement());
		formEClass.getESuperTypes().add(theGlot2Package.getNamedElement());
