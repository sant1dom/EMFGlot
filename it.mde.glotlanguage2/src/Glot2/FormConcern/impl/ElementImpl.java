 ...
 * </p>
 * <ul>
 *   <li>{@link Glot2.FormConcern.impl.ElementImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link Glot2.FormConcern.impl.ElementImpl#getTooltip <em>Tooltip</em>}</li>
 *   <li>{@link Glot2.FormConcern.impl.ElementImpl#getAttribute <em>Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElementImpl extends NamedElementImpl implements Element {
	...
	public void setTooltip(String newTooltip) {
		...
		tooltip = newTooltip;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormConcernPackage.ELEMENT__TOOLTIP, oldTooltip, tooltip));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FormConcernPackage.ELEMENT__LABEL:
				return getLabel();
			case FormConcernPackage.ELEMENT__TOOLTIP:
				return getTooltip();
