...
/**
 * This is the item provider adapter for a {@link Glot2.DataConcern.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_isPrimaryKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_isPrimaryKey_feature", "_UI_Attribute_type"),
				 DataConcernPackage.Literals.ATTRIBUTE__IS_PRIMARY_KEY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataConcernPackage.Literals.ATTRIBUTE__TYPE,
				 true,
				 false,
				 false,
