/**
 */
package Glot2.ContentConcern.provider;
...
import Glot2.provider.NamedElementItemProvider;
...
/**
 * This is the item provider adapter for a {@link Glot2.ContentConcern.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider extends NamedElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addFormsPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Forms feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFormsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Page_forms_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Page_forms_feature", "_UI_Page_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ContentConcernPackage.Literals.PAGE__INDIVIDUALS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ContentConcernPackage.Literals.PAGE__INDIVIDUALS,
				 ContentConcernFactory.eINSTANCE.createIndividual()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return Glotlanguage2EditPlugin.INSTANCE;
	}
