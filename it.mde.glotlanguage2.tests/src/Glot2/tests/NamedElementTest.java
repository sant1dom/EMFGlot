 ...
 * <ul>
 *   <li>{@link Glot2.NamedElement#NameIsDefined(java.lang.String) <em>Name Is Defined</em>}</li>
 *   <li>{@link Glot2.NamedElement#NameNotEmpty(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Name Not Empty</em>}</li>
 * </ul>
 * </p>
 * @generated
 */
public class NamedElementTest extends TestCase {
	...
	protected void setUp() throws Exception {
		setFixture(Glot2Factory.eINSTANCE.createNamedElement());
	}
	...
	/**
	 * Tests the '{@link Glot2.NamedElement#NameIsDefined(java.lang.String) <em>Name Is Defined</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see Glot2.NamedElement#NameIsDefined(java.lang.String)
	 * @generated
	 */
	public void testNameIsDefined__String() {
	...
	/**
	 * Tests the '{@link Glot2.NamedElement#NameNotEmpty(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Name Not Empty</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see Glot2.NamedElement#NameNotEmpty(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	public void testNameNotEmpty__DiagnosticChain_Map() {
		// TODO: implement this operation test method
		// Ensure that you remove @generated or mark it @generated NOT
		fail();
	}
