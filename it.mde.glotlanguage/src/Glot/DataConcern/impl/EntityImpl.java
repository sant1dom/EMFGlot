	...
	public boolean NoDuplicates(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			if (le) {
				...
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_Glot_c_c_DataConcern_c_c_Entity = idResolver.getClass(DataConcernTables.CLSSid_Entity, null);
				final /*@NonInvalid*/ SetValue allInstances = ClassifierAllInstancesOperation.INSTANCE.evaluate(executor, DataConcernTables.SET_CLSSid_Entity, TYP_Glot_c_c_DataConcern_c_c_Entity);
			...
			if (le) {
				...
				try {
					...
					while (true) {
						 ...
						 * a.oclAsType(Attribute).isPrimaryKey = true
						 */
						final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_Glot_c_c_DataConcern_c_c_Attribute = idResolver.getClass(DataConcernTables.CLSSid_Attribute, null);
						final /*@NonInvalid*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, a, TYP_Glot_c_c_DataConcern_c_c_Attribute).booleanValue();
						...
						if (!oclIsKindOf) {
							...
							try {
								final /*@Thrown*/ Attribute oclAsType = (Attribute)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, a, TYP_Glot_c_c_DataConcern_c_c_Attribute);
