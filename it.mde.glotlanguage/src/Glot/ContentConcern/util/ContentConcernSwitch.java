 ...
 * @generated
 */
public class ContentConcernSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ContentConcernPackage.DCONTENT: {
				DContent dContent = (DContent)theEObject;
				T result = caseDContent(dContent);
				if (result == null) result = caseContent(dContent);
				if (result == null) result = caseNamedElement(dContent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContentConcernPackage.DFORM: {
				DForm dForm = (DForm)theEObject;
				T result = caseDForm(dForm);
				if (result == null) result = caseContent(dForm);
				if (result == null) result = caseNamedElement(dForm);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseDContent(DContent object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>DForm</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>DForm</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDForm(DForm object) {
		return null;
	}
