 ...
 *   <li>{@link Glot.impl.SystemImpl#getFullVersion <em>Full Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SystemImpl extends NamedElementImpl implements Glot.System {
	...
	public void setFullVersion(String newFullVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GlotPackage.SYSTEM__FULL_VERSION, oldFullVersion, fullVersion));
	}
	...
	public String JoinVersion(final int version, final int subversion) {
		...
		final /*@NonInvalid*/ String concat = StringConcatOperation.INSTANCE.evaluate(toString, GlotTables.STR__0);
	...
	public boolean SubVersionBetweenZeroAndNine(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, GlotPackage.Literals.SYSTEM___SUB_VERSION_BETWEEN_ZERO_AND_NINE__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				final /*@NonInvalid*/ boolean lt = OclComparableLessThanOperation.INSTANCE.evaluate(executor, BOXED_subversion_0, GlotTables.INT_10).booleanValue();
				final /*@NonInvalid*/ Boolean status;
				if (!lt) {
					status = ValueUtil.FALSE_VALUE;
				}
				else {
					final /*@NonInvalid*/ boolean ge = OclComparableGreaterThanEqualOperation.INSTANCE.evaluate(executor, BOXED_subversion_0, GlotTables.INT_0).booleanValue();
					if (!ge) {
						status = ValueUtil.FALSE_VALUE;
					}
					else {
				...
				if (eq) {
					...
					final /*@NonInvalid*/ TupleValue local_0 = ValueUtil.createTupleOfEach(GlotTables.TUPLid_, GlotTables.STR_Subversion_32_should_32_be_32_between_32_zero_32_and_32_nine, status);
					local_1 = local_0;
				}
				final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, constraintName, this, (Object)null, diagnostics, context, (Object)null, severity_0, local_1, GlotTables.INT_0).booleanValue();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case GlotPackage.SYSTEM__PAGES:
				return getPages();
			case GlotPackage.SYSTEM__FULL_VERSION:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case GlotPackage.SYSTEM___JOIN_VERSION__INT_INT:
				return JoinVersion((Integer)arguments.get(0), (Integer)arguments.get(1));
			case GlotPackage.SYSTEM___SUB_VERSION_BETWEEN_ZERO_AND_NINE__DIAGNOSTICCHAIN_MAP:
